...
public class FaceDetector extends JFrame {
 ...
 private List < DetectedFace > faces = null;
	...
	public FaceDetector() throws IOException {
		 ...
		 * webcam.setViewSize(WebcamResolution.VGA.getSize()); webcam.open(true); img =
		 * webcam.getImage(); webcam.close(); ImagePanel panel = new ImagePanel(img);
		 * panel.setPreferredSize(WebcamResolution.VGA.getSize()); add(panel);
		 * setTitle("Face Recognizer"); setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
